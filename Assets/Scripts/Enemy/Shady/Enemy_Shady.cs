...
public class Enemy_Shady : Enemy
{
    ...
    [SerializeField] private GameObject explosivePrefabs;
    ...
    protected override void Awake()
    {
        ...
        battleState = new ShadyBattleState(this, stateMachine, "MoveFlast", this);
    }
    ...
    {
        GameObject newExplosive = Instantiate(explosivePrefabs, attackCheck.position, Quaternion.identity);
